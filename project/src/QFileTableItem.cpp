...
QFileTableItem::QFileTableItem(Q3Table * parent)
: Q3TableItem(parent, OnTyping)
{
}

QFileTableItem::~QFileTableItem()
{
}

QWidget * QFileTableItem::createEditor() const
{
...
void QFileTableItem::setContentFromEditor(QWidget * w)
{
